...
public class Command {
    ...
    public boolean checkArgumentsSize() {
        return switch (commandType) {
            case LISTLOBBIES, START, SHUTDOWN, SYNCHRONIZE, STARTTURN, ENDTURN, GETGAMESTATUS, GETPRICES, LEADERBOARD, CLAIMALL, RAGNAROK -> args.length == 0;
    ...
    public boolean isAdministrative() {
        return switch (commandType) {
            ...
            case RAGNAROK, CLAIMALL, BUYSTRUCTURE, BUYSTATUE, GETGAMESTATUS, GETPRICES, STARTTURN, ENDTURN, BUYTILE, PLACESTRUCTURE, USEPLAYERARTIFACT, UPGRADESTATUE, USESTATUE, USESTRUCTURE, USEFIELDARTIFACT  -> false;
            default -> {
