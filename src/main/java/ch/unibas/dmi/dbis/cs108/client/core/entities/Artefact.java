...
public class Artefact {
    private final int artifactID; // The ID of the artefact
    private final String name; // The name of the artefact
    private final String description; // The description of the artefact
    private final String useType; // The type of use for the artefact
